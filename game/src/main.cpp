...
// 
    ...
    std::vector<unsigned int> lightInd(lightIndices, lightIndices + 36);
    std::vector<Texture> tex(textures, textures + 2);
    Mesh light(lightVerts, lightInd, tex); // reuse textures for now

    glm::vec3 lightPos = glm::vec3(1.1f, 1.1f, 1.1f);
    glm::mat4 lightModel = glm::translate(glm::mat4(1.0f), lightPos);


// 
    Model model;
    model.LoadFromOBJ("/home/fly/Documents/SKY/game/obj/low_poly_tree/Lowpoly_tree_sample.obj");
